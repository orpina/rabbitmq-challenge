using MediatR;
using RabbitMQChallenge.Analytics.Application.EventHandlers;
...
void ConfigureBusSubscription()
{
    ...
    messageBus.Subscribe<LocationUpdateEvent, LocationUpdateEventHandler>(app.Configuration["BusConfig:AnalyticsQueue"]!);
}